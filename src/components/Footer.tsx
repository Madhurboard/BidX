        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            ...
            <p className="text-gray-400">
              India's premier online auction platform connecting sellers with enthusiastic buyers.
            </p>
          </div>
              ...
              <div className="flex space-x-3">
                <div className="bg-white p-1 rounded">
                  <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/e/e1/UPI-Logo-vector.svg/1200px-UPI-Logo-vector.svg.png" 
                       alt="UPI" className="h-6" />
                </div>
                <div className="bg-white p-1 rounded">
                  <img src="https://uxwing.com/wp-content/themes/uxwing/download/brands-and-social-media/phonepe-logo-icon.png" 
                       alt="PhonePe" className="h-6" />
                </div>
                <div className="bg-white p-1 rounded">
                  <img src="https://static.vecteezy.com/system/resources/thumbnails/020/191/342/small_2x/google-pay-logo-gpay-icon-in-india-free-png.png" 
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="mt-4 md:mt-0">
            <p className="text-xs text-gray-500">
              Designed and developed for demonstration purposes only.
            </p>
          </div>
        </div>
      </div>
